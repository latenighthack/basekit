 ...
 * interface `I` and a trailing `Screen`/`Destination`/`Route` suffix. Mirrors the navigation slice so
 * the generated screens implement the exact same `…Navigator` interfaces. e.g. "HomeScreen" -> "home".
 */
